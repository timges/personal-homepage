<section>
	...
	<p>
		This Privacy Policy describes My policies and procedures on the collection, use and disclosure
	...
	<ul>
		<li>
			<p>
				<strong>Account</strong> means a unique account created for You to access my Service or parts
				of my Service.
			</p>
		</li>
		<li>
		...
		<li>
			<p>
				...
				or &quot;My&quot; in this Agreement) refers to Tim Gesemann.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Tim Gesemann, accessible from
				<a href="tim-gesemann.dev" rel="external nofollow noopener" target="_blank"
					>tim-gesemann.dev</a
				>
			</p>
		</li>
	...
	<h4>Personal Data</h4>
	<p>
		While using My Service, We may ask You to provide Us with certain personally identifiable
	...
	<p>
		We may also collect information that Your browser sends whenever You visit my Service or when
	...
	<ul>
		<li>
			<p>
				<strong>To provide and maintain my Service</strong>, including to monitor the usage of my
				Service.
			</p>
		</li>
		<li>
			<p>
				...
				necessary or reasonable for their implementation. Email contact is executed through the
				Sendgrid service. The privacy policy of Sendgrid can be found at
				<a
					href="https://sendgrid.com/policies/privacy/services-privacy-policy/"
					rel="external nofollow noopener"
					target="_blank">https://sendgrid.com/policies/privacy/services-privacy-policy/</a
				>
			</p>
		</li>
		<li>
		...
		<li>
			<p>
				...
				some or all of My assets, whether as a going concern or as part of bankruptcy, liquidation, or
				similar proceeding, in which Personal Data held by Us about my Service users is among the assets
				transferred.
			</p>
		</li>
		<li>
			<p>
				...
				data analysis, identifying usage trends, determining the effectiveness of my promotional
				campaigns and to evaluate and improve my Service, products, services, marketing and your
				experience.
			</p>
		</li>
	</ul>
	...
	<ul>
		<li>
			...
			to monitor and analyze the use of my Service, to contact You.
		</li>
		<li>
			...
			of all or a portion of My business to another company.
		</li>
		<li>
			<strong>With Affiliates:</strong> We may share Your information with My affiliates, in which case
			we will require those affiliates to honor this Privacy Policy. Affiliates include My parent company
			and any other subsidiaries, joint venture partners or other companies that We control or that are
			under common control with Us.
		</li>
		<li>
			<strong>With business partners:</strong> We may share Your information with My business partners
	...
	<p>
		...
		comply with my legal obligations (for example, if we are required to retain your data to comply
	...
	<p>
		...
		or to improve the functionality of My Service, or We are legally obligated to retain this data
	...
	<p>
		My Service may give You the ability to delete certain information about You from within the
		Service.
	</p>
	<p>
	...
	<p>
		My Service does not address anyone under the age of 13. We do not knowingly collect personally
		...
		verification of parental consent, We take steps to remove that information from My servers.
	</p>
	<p>
	...
	<p>
		My Service may contain links to other websites that are not operated by Us. If You click on a
	...
	<p>
		We may update My Privacy Policy from time to time. We will notify You of any changes by posting
		the new Privacy Policy on this page.
	</p>
	<p>
		We will let You know via email and/or a prominent notice on My Service, prior to the change
	...
	<ul>
		<li>
			<p>By email: contact@tim-gesemann.dev</p>
		</li>
		<li>
			<p>
				By visiting this page on my website: <a
					href="tim-gesemann.dev"
					rel="external nofollow noopener"
					target="_blank">tim-gesemann.dev</a
				>
			</p>
		</li>
	</ul>
