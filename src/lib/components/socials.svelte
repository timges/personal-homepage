	...
	<div class="socials">
		<a target="_blank" href="https://github.com/timges">
			<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<title>Link Icon to github profile</title>
				<path
		...
		<a target="_blank" href="https://www.linkedin.com/in/tim-gesemann/">
			<title>Link icon to linkedin profile</title>
			<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<path
		...
		<a target="_blank" href="https://twitter.com/geezy_tim">
			<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<title>Link icon to twitter profile</title>
				<path
		...
		<a target="_blank" href="https://www.instagram.com/_nnameseg/">
			<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<title>Link icon to instagram profile</title>
				<path
